...
def build_std_table():
    ...
    p2 = [
        row("SVM",
            ...
            pb["SVM"]["mean_accuracy"],
            pb["SVM"]["std_accuracy"],  pb["SVM"]["std_macro_f1"],
            pb["SVM"].get("balanced_acc_std")),
        row("Random Forest",
        ...
        row("GNN (learnable adj)",
            ...
            abl["ablation_learnable_adj"].get("accuracy_std"),
            abl["ablation_learnable_adj"].get("macro_f1_std"),
            abl["ablation_learnable_adj"].get("balanced_acc_std")),
        row("Flatten+LSTM",
            abl["ablation_flatten_lstm"]["accuracy"],
            abl["ablation_flatten_lstm"]["macro_f1"],
            abl["ablation_flatten_lstm"]["balanced_acc"],
            abl["ablation_flatten_lstm"].get("accuracy_std"),
            abl["ablation_flatten_lstm"].get("macro_f1_std"),
            abl["ablation_flatten_lstm"].get("balanced_acc_std")),
        row("CNN1D",
            cn["pamap2"]["accuracy"], cn["pamap2"]["macro_f1"], cn["pamap2"]["balanced_acc"],
            cn["pamap2"].get("accuracy_std"), cn["pamap2"].get("macro_f1_std"), cn["pamap2"].get("balanced_acc_std")),
        row("ImprovedGNNLSTM ★",
